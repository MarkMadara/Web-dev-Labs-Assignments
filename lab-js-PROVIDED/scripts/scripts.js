...
function recalculate() {
    ...
    if (modelName == "Model XYZ") {
        let newTotalCost = duration * 100.00;
        costLabel.innerHTML = newTotalCost;
    } 
    if (modelName == "Model CPRG") {
        let newTotalCost = duration * 213.00;
        costLabel.innerHTML = newTotalCost;
    }
}
...
function changeDuration() {
    let durationValue =  document.getElementById("duration-text");
    duration = (prompt("Enter a new duration"));
    durationValue.innerHTML = duration;
    recalculate();
}
